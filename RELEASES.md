...
| --- | --- | --- | --- | --- | --- |
| 1.0.45 | `SarifPro-v1.0.45-CANDIDATE.apk` | 2026-09-08 | Internal candidate | v1.0.44 stabilization candidate only. Fixes unsafe stale USSD lock clearing, deterministic two-decimal truncation, pre-transfer settings validation, and adds non-sensitive automation diagnostics plus regression tests. Not tagged or customer-approved. | Physical-device regression still pending: direct USSD, Dara-Salaam, slow USSD response, locked/background monitoring, network interruption, process kill, late 898 confirmation, duplicate trigger, and Accessibility restart. |
